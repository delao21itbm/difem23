...
Object: ReporteIngresosPropiosAlMes.jrxml

Fecha de Creación                    Autor                             Descripcion                      Versión                        Linea de Codigo

---------------       ---------------------------------     -----------------------------          -----------                     -------------------

06/05/2021            Luis Enrique Longino Nicolas. 		Se crea módulo para el reporte de      	1.0
                             								Ingresos Propios al Mes
 ...
 */
@ManagedBean(name = "reporteIngresosPropiosAlMesMB")
@ViewScoped
public class ReporteIngresosPropiosAlMesMB extends BaseDirectReport {
	...
	@PostConstruct
	public void init() {
		jasperReporteName = "ingresosPropiosAlMes";
	...
	public Map<String, Object> getParametersReports() throws ReportValidationException {
		...
		if (Integer.valueOf(mes) == 1) {
			...
			this.total = tcIngresoPropioRepository.getTotalIngresos(1, Integer.valueOf(mes) - 1, clave);
		}
