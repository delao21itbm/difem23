 ...
 *
 */
@ManagedBean(name = "eAPEProyectoMB")
@ViewScoped
public class EAPEProyectoMB extends BaseDirectReport {
	...
	public void init() {
		...
		listMuninep = muninepRepository.getListSubProyecto(this.getUserDetails().getIdSector());
	...
	public Map<String, Object> getParametersReports() throws ReportValidationException {
		...
		parameters.put("p_Mun", conctb.getAnoemp());
		if (idSector == 2) {
	...
	public String generateQuery(Integer idsector, Integer mes, String xdire) {
		...
		sSql.append(" FROM").append(" PASO P JOIN NATGAS N ").append(" ON N.CLVGAS= P.PARTIDA ")
				...
				.append(" AND SUBSTR(P.PROGRAMA,1,12)='" + xdire + "'").append(" GROUP BY P.PARTIDA,N.NOMGAS)")
