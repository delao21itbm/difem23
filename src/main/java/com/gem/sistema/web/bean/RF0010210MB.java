...
/**
 * The Class RF0010210MB.
 */
@ManagedBean (name = "rF0010210MB")
@ViewScoped
public class RF0010210MB extends GenericExecuteProcedure {
	...
	public void init() {
		...
		procedureName = "SP_GENERA_TXT_RF0010_2_10";
	...
	public void downLoadFile() throws ReportValidationException {
		...
		if (Integer.valueOf(out.get("O_COD_ERROR").toString()) > 0) {
			String zipFile = "/gem/downcvs/CuentasPolizas.zip";

			String[] srcFiles = { out.get("O_RUTA_FILE").toString() + "/" + out.get("O_NAME_FILE_1").toString(),
					out.get("O_RUTA_FILE").toString() + "/" + out.get("O_NAME_FILE_2").toString()};
			try {
				// create byte buffer
				...
				LOGGER.info("Error al crear el archivo zip, {}", ioe.toString());
