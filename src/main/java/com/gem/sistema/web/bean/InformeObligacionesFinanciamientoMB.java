...
@ManagedBean(name = "informeObligacionesFinanciamientoMB")
@ViewScoped
public class InformeObligacionesFinanciamientoMB extends ReportePeriodos {
	...
	public void init() {
		...
		jasperReporteName = "informeObligacionesFinanciamientos";
