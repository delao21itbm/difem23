...
/**
 * The Class DesafectacionMB.
 */
@ManagedBean(name = "desafectacionMB")
@ViewScoped
public class DesafectacionMB extends AbstractMB{
	
	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(DesafectacionMB.class);
	...
	private static final String contrasena = "dxafecta2016";
	...
	public void desafecta() {
		Poliza poliza = polizaService.desafecta(mes,  this.getUserDetails().getIdSector());
