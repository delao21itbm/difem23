...
import com.gem.sistema.business.service.catalogos.Pm3311Service;
...
/**
 * The Class Reporte149MB.
 */
@ManagedBean(name = "reporte149MB")
@ViewScoped
public class Reporte149MB extends BaseDirectReport {
	...
	/** The pm 3311. */
	private Pm3311 pm3311;
	
	/** The list pm 3311. */
	private List<Pm3311> listPm3311;
	...
	/** The pm 3311 service. */
	@ManagedProperty("#{pm3311Service}")
	private Pm3311Service pm3311Service;

	/** The pm 3311 repository. */
	@ManagedProperty("#{pm3311Repository}")
	 ...
	 * Sets the pm 3311.
	 *
	 * @param pm3311 the new pm 3311
	 */
	public void setPm3311(Pm3311 pm3311) {
		this.pm3311 = pm3311;
	}

	/**
	 * Gets the list pm 3311.
	 *
	 * @return the list pm 3311
	 */
	public List<Pm3311> getListPm3311() {
		return listPm3311;
	}

	/**
	 * Sets the list pm 3311.
	 *
	 * @param listPm3311 the new list pm 3311
	 */
	public void setListPm3311(List<Pm3311> listPm3311) {
		this.listPm3311 = listPm3311;
	}
	...
	/**
	 * Gets the pm 3311 service.
	 *
	 * @return the pm 3311 service
	 */
	public Pm3311Service getPm3311Service() {
		return pm3311Service;
	}

	/**
	 * Sets the pm 3311 service.
	 *
	 * @param pm3311Service the new pm 3311 service
	 */
	public void setPm3311Service(Pm3311Service pm3311Service) {
		this.pm3311Service = pm3311Service;
	}
	...
	public void init() {
		...
		pm3311 = pm3311Repository.findAllByIdsector(this.getUserDetails().getIdSector());
		if (null == pm3311) {
			bLblTrimestre = Boolean.TRUE;
			bComboTri = Boolean.FALSE;
			bLbl = Boolean.TRUE;
	...
	public void save() {
		...
		if (bModificar) {
			...
			boolean bandera = pm3311Service.save(pm3311);
	...
	public void clean() {
		if (bModificar) {
			...
			pm3311 = pm3311Service.clean(pm3311);
	}
	 ...
	 * @return the pm 3311
	 */
	public Pm3311 entitySave(Pm3311 entity) {
		pm3311 = new Pm3311();
		pm3311 = entity;
		pm3311.setUserid(this.getUserDetails().getUsername());
		pm3311.setIdRef(0L);
		pm3311.setIdsector(this.getUserDetails().getIdSector());
		pm3311.setFeccap(Calendar.getInstance().getTime());
		pm3311.setCapturo(this.getUserDetails().getUsername());
		pm3311.setAnual(anual);
		return pm3311;
	}
