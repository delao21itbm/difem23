...
@NamedStoredProcedureQueries({
  @NamedStoredProcedureQuery(name = "genera_partidas_en_cero",
                             procedureName="SP_GENERA_PARTIDAS_PRESUPUESTALES_EN_CERO",
                             parameters = {
                               ...
                               @StoredProcedureParameter(mode = ParameterMode.IN, name = "USER_NAME", type = String.class),
															 @StoredProcedureParameter(mode = ParameterMode.OUT, name = "INSERTED_ROWS", type = String.class)
                             }),
  @NamedStoredProcedureQuery(name = "pistov409",
                              procedureName="SP_PISTOV409",
                              parameters = {
                                @StoredProcedureParameter(mode = ParameterMode.IN, name = "ID_SECTOR", type = Integer.class),
                                @StoredProcedureParameter(mode = ParameterMode.IN, name = "USER_ID", type = String.class),
                           			@StoredProcedureParameter(mode = ParameterMode.OUT, name = "NOTFOUND_ROWS", type = String.class)
                                })

})
@NamedQuery(name="Paso.findAll", query="SELECT p FROM Paso p")
public class Paso extends MonthlyAbstractEntity implements Serializable {
	...
	/** The compro 11. */
	@Column(name="COMPRO1_1")
	private BigDecimal compro11;

	/** The compro 110. */
	@Column(name="COMPRO1_10")
	private BigDecimal compro110;

	/** The compro 111. */
	@Column(name="COMPRO1_11")
	private BigDecimal compro111;

	/** The compro 112. */
	@Column(name="COMPRO1_12")
	private BigDecimal compro112;

	/** The compro 113. */
	@Column(name="COMPRO1_13")
	private BigDecimal compro113;

	/** The compro 12. */
	@Column(name="COMPRO1_2")
	private BigDecimal compro12;

	/** The compro 13. */
	@Column(name="COMPRO1_3")
	private BigDecimal compro13;

	/** The compro 14. */
	@Column(name="COMPRO1_4")
	private BigDecimal compro14;

	/** The compro 15. */
	@Column(name="COMPRO1_5")
	private BigDecimal compro15;

	/** The compro 16. */
	@Column(name="COMPRO1_6")
	private BigDecimal compro16;

	/** The compro 17. */
	@Column(name="COMPRO1_7")
	private BigDecimal compro17;

	/** The compro 18. */
	@Column(name="COMPRO1_8")
	private BigDecimal compro18;

	/** The compro 19. */
	@Column(name="COMPRO1_9")
	private BigDecimal compro19;
	 ...
	 * Gets the compro 11.
	 *
	 * @return the compro 11
	 */
	public BigDecimal getCompro11() {
		return this.compro11;
	}

	/**
	 * Sets the compro 11.
	 *
	 * @param compro11 the new compro 11
	 */
	public void setCompro11(BigDecimal compro11) {
		this.compro11 = compro11;
	}

	/**
	 * Gets the compro 110.
	 *
	 * @return the compro 110
	 */
	public BigDecimal getCompro110() {
		return this.compro110;
	}

	/**
	 * Sets the compro 110.
	 *
	 * @param compro110 the new compro 110
	 */
	public void setCompro110(BigDecimal compro110) {
		this.compro110 = compro110;
	}

	/**
	 * Gets the compro 111.
	 *
	 * @return the compro 111
	 */
	public BigDecimal getCompro111() {
		return this.compro111;
	}

	/**
	 * Sets the compro 111.
	 *
	 * @param compro111 the new compro 111
	 */
	public void setCompro111(BigDecimal compro111) {
		this.compro111 = compro111;
	}

	/**
	 * Gets the compro 112.
	 *
	 * @return the compro 112
	 */
	public BigDecimal getCompro112() {
		return this.compro112;
	}

	/**
	 * Sets the compro 112.
	 *
	 * @param compro112 the new compro 112
	 */
	public void setCompro112(BigDecimal compro112) {
		this.compro112 = compro112;
	}

	/**
	 * Gets the compro 113.
	 *
	 * @return the compro 113
	 */
	public BigDecimal getCompro113() {
		return this.compro113;
	}

	/**
	 * Sets the compro 113.
	 *
	 * @param compro113 the new compro 113
	 */
	public void setCompro113(BigDecimal compro113) {
		this.compro113 = compro113;
	}

	/**
	 * Gets the compro 12.
	 *
	 * @return the compro 12
	 */
	public BigDecimal getCompro12() {
		return this.compro12;
	}

	/**
	 * Sets the compro 12.
	 *
	 * @param compro12 the new compro 12
	 */
	public void setCompro12(BigDecimal compro12) {
		this.compro12 = compro12;
	}

	/**
	 * Gets the compro 13.
	 *
	 * @return the compro 13
	 */
	public BigDecimal getCompro13() {
		return this.compro13;
	}

	/**
	 * Sets the compro 13.
	 *
	 * @param compro13 the new compro 13
	 */
	public void setCompro13(BigDecimal compro13) {
		this.compro13 = compro13;
	}

	/**
	 * Gets the compro 14.
	 *
	 * @return the compro 14
	 */
	public BigDecimal getCompro14() {
		return this.compro14;
	}

	/**
	 * Sets the compro 14.
	 *
	 * @param compro14 the new compro 14
	 */
	public void setCompro14(BigDecimal compro14) {
		this.compro14 = compro14;
	}

	/**
	 * Gets the compro 15.
	 *
	 * @return the compro 15
	 */
	public BigDecimal getCompro15() {
		return this.compro15;
	}

	/**
	 * Sets the compro 15.
	 *
	 * @param compro15 the new compro 15
	 */
	public void setCompro15(BigDecimal compro15) {
		this.compro15 = compro15;
	}

	/**
	 * Gets the compro 16.
	 *
	 * @return the compro 16
	 */
	public BigDecimal getCompro16() {
		return this.compro16;
	}

	/**
	 * Sets the compro 16.
	 *
	 * @param compro16 the new compro 16
	 */
	public void setCompro16(BigDecimal compro16) {
		this.compro16 = compro16;
	}

	/**
	 * Gets the compro 17.
	 *
	 * @return the compro 17
	 */
	public BigDecimal getCompro17() {
		return this.compro17;
	}

	/**
	 * Sets the compro 17.
	 *
	 * @param compro17 the new compro 17
	 */
	public void setCompro17(BigDecimal compro17) {
		this.compro17 = compro17;
	}

	/**
	 * Gets the compro 18.
	 *
	 * @return the compro 18
	 */
	public BigDecimal getCompro18() {
		return this.compro18;
	}

	/**
	 * Sets the compro 18.
	 *
	 * @param compro18 the new compro 18
	 */
	public void setCompro18(BigDecimal compro18) {
		this.compro18 = compro18;
	}

	/**
	 * Gets the compro 19.
	 *
	 * @return the compro 19
	 */
	public BigDecimal getCompro19() {
		return this.compro19;
	}

	/**
	 * Sets the compro 19.
	 *
	 * @param compro19 the new compro 19
	 */
	public void setCompro19(BigDecimal compro19) {
		this.compro19 = compro19;
	}
