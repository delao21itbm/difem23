...
/**
 * The persistent class for the PP_METAS database table.
 * 
 */
@Entity
@Table(name = "PP_METAS")
@NamedQuery(name = "PpMeta.findAll", query = "SELECT p FROM PpMeta p")
public class PpMeta implements Serializable {
	...
	@Transient
	@IgnoredQuery
	private Boolean bGugardar;

	/**
	 * Instantiates a new pp meta.
	 */
	public PpMeta() {
	}
	 ...
	 * Gets the b gugardar.
	 *
	 * @return the b gugardar
	 */
	public Boolean getbGugardar() {
		return bGugardar;
	}
	 ...
	 * Sets the b gugardar.
	 *
	 * @param bGugardar the new b gugardar
	 */
	public void setbGugardar(Boolean bGugardar) {
		this.bGugardar = bGugardar;
	}
