...
/**
 * The persistent class for the PM4211 database table.
 * 
 * @author Alfredo
 *
 */
@Entity
@NamedQuery(name="Pm4211.findAll", query="SELECT p FROM Pm4211 p")
public class Pm4211 extends AbstractEntity implements Serializable {
