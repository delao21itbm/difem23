...
/**
 * The persistent class for the PM5311 database table.
 * 
 * @author Alfredo
 *
 */
@Entity
@NamedQuery(name="Pm5311.findAll", query="SELECT p FROM Pm5311 p")
public class Pm5311 extends AbstractEntity implements Serializable {
