...
public class Finalidad extends AbstractEntity implements Serializable {
	...
	public Long getCvefinal() {
		return this.cvefinal;
	}

	public void setCvefinal(Long cvefinal) {
	...
	public String toString() {
		return "Finalidad [clvdepg=" + clvdepg + ", cvefin=" + cvefin + ", cvefinal=" + cvefinal + ", cveind=" + cveind
				+ ", cveprog=" + cveprog + ", cvetemas=" + cvetemas + ", feccap=" + feccap + ", formula=" + formula
				+ ", frecuencia=" + frecuencia + ", idRef=" + idRef + ", medio=" + medio + ", nombre=" + nombre
				+ ", objetivo=" + objetivo + ", sectorid=" + sectorid + ", supuesto=" + supuesto + ", userid=" + userid
				+ ", usuario=" + usuario + "]";
	}
