...
/**
 * The Class MetasFisicasDetalleDTO.
 */
public class MetasFisicasDetalleDTO {
	...
	/**
	 * Instantiates a new metas fisicas detalle DTO.
	 */
	public MetasFisicasDetalleDTO() {
		super();
		progante = new BigDecimal(0);
		canMeti = new BigDecimal(0);
		canMetia = new BigDecimal(0);
		canMetic1 = new BigDecimal(0);
		canMetic2 = new BigDecimal(0);
		canMetic3 = new BigDecimal(0);
		canMetic4 = new BigDecimal(0);
		ampli1 = new BigDecimal(0);
		ampli2 = new BigDecimal(0);
		ampli3 = new BigDecimal(0);
		ampli4 = new BigDecimal(0);
		redu1 = new BigDecimal(0);
		redu2 = new BigDecimal(0);
		redu3 = new BigDecimal(0);
		redu4 = new BigDecimal(0);
		cantAvan1 = new BigDecimal(0);
		cantAvan2 = new BigDecimal(0);
		cantAvan3 = new BigDecimal(0);
		cantAvan4 = new BigDecimal(0);
	}
